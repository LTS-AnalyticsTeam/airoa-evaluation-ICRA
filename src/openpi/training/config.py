...
_CONFIGS = [
    ...
    *roboarena_config.get_roboarena_configs(),
    TrainConfig(
        name="pi05_task6891011_level12_v2_fix_relative_train",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,  # pi05 is trained with 32-dim actions
            action_horizon=16,
        ...
        data=LeRobotHSRDataConfig(
            repo_id="lerobot_datasets/task6891011_level12_v2_train",
            assets=AssetsConfig(
                assets_dir="./assets/task6891011_level12_v2_train",
                asset_id="lerobot_datasets/task6891011_level12_v2_train",
            ),
            base_config=DataConfig(
                prompt_from_task=True,
            ),
    ...
    TrainConfig(
        name="pi05_task68911_level12_fix_relative_train",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,  # pi05 is trained with 32-dim actions
            action_horizon=16,
        ...
        data=LeRobotHSRDataConfig(
            repo_id="lerobot_datasets/task68911_level12_fix_relative_train",
            assets=AssetsConfig(
                assets_dir="./assets/pi05_task68911_level12_fix_relative_train",
                asset_id="lerobot_datasets/task68911_level12_fix_relative_train",
            ),
            base_config=DataConfig(
                prompt_from_task=True,
            ),
        ...
        lr_schedule=_optimizer.CosineDecaySchedule( # batch 64
            warmup_steps=1_000,
            peak_lr=3.5e-5,     # 2.5e-5 × √2 = 3.5e-5
            decay_steps=850_000,  # Match num_train_steps.
            decay_lr=3.5e-6,    # 2.5e-6 × √2 = 3.5e-6
        ),
        batch_size=64,
        num_workers=8,
        num_train_steps=850_000,
    ),
    TrainConfig(
        name="pi05_task6891011_level12_fix_relative_train",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,  # pi05 is trained with 32-dim actions
            action_horizon=16,
        ...
        data=LeRobotHSRDataConfig(
            repo_id="lerobot_datasets/task6891011_level12_train",
            assets=AssetsConfig(
                assets_dir="./assets/pi05_task6891011_level12_fix_relative_train",
                asset_id="lerobot_datasets/task6891011_level12_train",
            ),
            base_config=DataConfig(
                prompt_from_task=True,
            ),
        ...
        lr_schedule=_optimizer.CosineDecaySchedule( # batch 64
            warmup_steps=1_000,
            peak_lr=3.5e-5,     # 2.5e-5 × √2 = 3.5e-5
            decay_steps=1_055_000,  # Match num_train_steps.
            decay_lr=3.5e-6,    # 2.5e-6 × √2 = 3.5e-6
        ),
        batch_size=64,
        num_workers=8,
        num_train_steps=1_055_000,
    ),
    TrainConfig(
        name="pi05_task6891011_level12_absolute_train",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=32,  # pi05 is trained with 32-dim actions
            action_horizon=16,
        ...
        data=LeRobotHSRDataConfig(
            repo_id="lerobot_datasets/task6891011_level12_train",
            assets=AssetsConfig(
                assets_dir="./assets/pi05_task6891011_level12_absolute_train",
                asset_id="lerobot_datasets/task6891011_level12_train",
            ),
            base_config=DataConfig(
                prompt_from_task=True,
